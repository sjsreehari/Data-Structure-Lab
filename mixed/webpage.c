// Question : implementb backward and forward navigation of visited webpages in a web browser ( that is backward and forward buttons) using doubly linked list operations
